Feature: The Wishlist service back-end
    ...
    Scenario: Unpublish a Wishlist
        When I visit the "Home Page"
        And I set the "Username" to "user4"
        And I set the "Name" to "wishlist 4"
        And I select "True" in the "Is Public" dropdown
        And I set the "Description" to "description 4"
        And I press the "Create" button
        Then I should see the message "Success"
        When I copy the "ID" field
        And I press the "Clear" button
        ...
        Then I should see the message "Wishlist has been unpublished!"
        When  I press the "Clear" button
        And I paste the "ID" field
        And I press the "Retrieve" button
        Then I should see the message "Success"
        ...
        And I should see "False" in the "Is Public" dropdown
        And I should see "description 4" in the "Description" field